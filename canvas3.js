...
var tooltipcanvas3 = document.getElementById("tooltip-canvas3");

var gradientBlue = canvas3.getContext('2d').createLinearGradient(0, 0, 0, 150);
gradientBlue.addColorStop(0, '#5555FF');
gradientBlue.addColorStop(1, '#9787FF');

var gradientRed = canvas3.getContext('2d').createLinearGradient(0, 0, 0, 150);
gradientRed.addColorStop(0, '#FF55B8');
gradientRed.addColorStop(1, '#FF8787');

var gradientGrey = canvas3.getContext('2d').createLinearGradient(0, 0, 0, 150);
...
function textInCenter(value, label) {
  var ctx = tooltipcanvas3.getContext('2d');
  ctx.clearRect(0, 0, tooltipcanvas3.width, tooltipcanvas3.height)
  ...
  var textPosition = {
    x: Math.round((tooltipcanvas3.width - ctx.measureText(value).width) / 2),
    y: tooltipcanvas3.height / 2,
  };
  ...
  var labelTextPosition = {
    x: Math.round((tooltipcanvas3.width - ctx.measureText(label).width) / 2),
    y: tooltipcanvas3.height / 2,
  };
...
window.chart = new Chart(canvas3, config);
