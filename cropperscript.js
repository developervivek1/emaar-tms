...
// 
  ...
  $('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded").attr("src", response);
...
$('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded2").attr("src", response);
      console.log(response);
      $('#uploadimageModal').modal('hide');
      // $.ajax({
      //   url:"upload.php",
...
$('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded3").attr("src", response);
      console.log(response);
      $('#uploadimageModal').modal('hide');
...
$('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded4").attr("src", response);
      console.log(response);
      $('#uploadimageModal').modal('hide');
...
$('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded5").attr("src", response);
      console.log(response);
      $('#uploadimageModal').modal('hide');
...
$('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $("#image_to_be_uploaded6").attr("src", response);
      console.log(response);
      $('#uploadimageModal').modal('hide');
